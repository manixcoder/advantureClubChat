<div class="content add_adventure_users">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h4 class="pull-left page-title"><a href="{{URL::to('terms-conditions')}}" >Terms & Conditions</a> > Edit</h4>
            </div>
        </div>

        <form  action="{{ URL::to('terms-conditions/add') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
