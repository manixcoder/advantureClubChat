                    ...
                    <div class="form">
                        ...
                        <form class="cmxform form-horizontal tasi-form" id="loginForm" method="POST" action="{{ route('login') }}" novalidate="novalidate">
                            ...
                            <div class="form-group">
                                <div class="col-12">
                                    <input id="username" type="text" class="form-control input-lg @error('username') is-invalid @enderror" name="email" value="{{ old('username') }}" autocomplete="username" required="" aria-required="true" autofocus placeholder="Email Address">
                                    @error('username')
                            ...
                            <div class="form-group retrieve_btn">
                                <div class="col-6">
                                    <a href="{{url('/forgot-password')}}">Retrieve Password</a>
                                </div>
                                <div class="col-6">
